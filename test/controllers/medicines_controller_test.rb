...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference("Medicine.count") do
      post medicines_url, params: { medicine: { dosage: @medicine.dosage, name: @medicine.name, sideEffects: @medicine.sideEffects, use: @medicine.use } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { dosage: @medicine.dosage, name: @medicine.name, sideEffects: @medicine.sideEffects, use: @medicine.use } }
